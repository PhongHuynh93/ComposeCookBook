...
fun ShimmerItemPrev() {
    ComposeCookBookTheme {
        Surface(
            ...
            ShimmerItem(
                lists = listOf(Color.LightGray.copy(alpha = 0.6f), Color.LightGray),
                isVertical = true
            )
        }
    }
...
@Preview(name = "vertical item big shimmer")
@Composable
fun ShimmerItemBigPrev() {
    ComposeCookBookTheme {
        Surface(
            color = MaterialTheme.colorScheme.background
        ) {
